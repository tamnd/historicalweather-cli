---
title: "historicalweather"
description: "A command line for historicalweather."
heroTitle: "historicalweather, from the command line"
heroLead: "A command line for historicalweather. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
historicalweather links <path>           # the pages it links to, each addressable
historicalweather serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading historicalweather by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address historicalweather as
  `historicalweather://` URIs and follow links across sites. See
