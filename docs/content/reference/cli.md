...
```
historicalweather <command> [arguments] [flags]
```

Run `historicalweather <command> --help` for the full flag list on any command. This
...
per operation you declare in `historicalweather/domain.go`.
