...
Most of these come down to network reality or how historicalweather serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

historicalweather rate-limits like any public site. historicalweather already paces
...
Where a surface is gated, historicalweather reads a cookie or token you supply
...
`historicalweather`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what historicalweather actually did
